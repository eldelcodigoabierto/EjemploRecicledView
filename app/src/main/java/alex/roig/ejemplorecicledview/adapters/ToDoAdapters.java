package alex.roig.ejemplorecicledview.adapters;
...
import alex.roig.ejemplorecicledview.R;
import alex.roig.ejemplorecicledview.modelos.ToDo;

public class ToDoAdapters extends RecyclerView.Adapter<ToDoAdapters.ToDoVH> {
    private List<ToDo> objects; //la lista de tareas
    private int resource; //la fila, la vist para construir la fila
    private Context context; //la actividad que tiene el RecyclerView para mostrar

    public ToDoAdapters(List<ToDo> objects, int resource, Context context) {
    ...
    public int getItemCount() {
        //sirve para que el adapter sepa cuantos elementos tiene
        return objects.size();
    }
    ...
    public class ToDoVH extends RecyclerView.ViewHolder{
        ...
        public ToDoVH(@NonNull View itemView) {
            ...
            lbTitulo = itemView.findViewById(R.id.lbTtituloToDoModel);
